...
class MenuViewTest(TestCase):
    ...
    def test_getall(self):
        ...
        self.assertEqual(response.json(), [
            {'id': 2, 'title': 'Ice Cream', 'price': '5.99', 'inventory': 100},
            {'id': 3, 'title': 'Pizza', 'price': '8.99', 'inventory': 50},
            {'id': 4, 'title': 'Burger', 'price': '6.99', 'inventory': 75},
            {'id': 5, 'title': 'Pasta', 'price': '7.99', 'inventory': 30}
        ])